...
// used: cutllinkedlist
#include "cs2/datatypes/utllinkedlist.h"
// used: fnv1a hashing
...
public:
	...
	{
		for (auto i = Interface::Cvar->listConvars.m_Head; i != Interface::Cvar->listConvars.kInvalidIndex;) {

			CConVar* pConVar = Interface::Cvar->listConvars.memory[i].m_Element;
			if (pConVar == nullptr)
				continue;

			i = Interface::Cvar->listConvars.memory[i].m_Next;
