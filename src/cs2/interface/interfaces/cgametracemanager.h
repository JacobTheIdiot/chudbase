...
public:
	bool TraceShape(Ray_t* pRay, Vector_t vecStart, Vector_t vecEnd, TraceFilter_t* pFilter, GameTrace_t* pGameTrace)
	{
		...
		static fnTraceShape oTraceShape = reinterpret_cast<fnTraceShape>(memory::FindPattern(CLIENT_DLL, XOR("48 89 5C 24 20 48 89 4C 24 08 55 56 41")));
	...
	bool ClipRayToEntity(Ray_t* pRay, Vector_t vecStart, Vector_t vecEnd, C_CSPlayerPawn* pPawn, TraceFilter_t* pFilter, GameTrace_t* pGameTrace)
	{
		...
		static fnClipRayToEntity oClipRayToEntity = reinterpret_cast<fnClipRayToEntity>(memory::FindPattern(CLIENT_DLL, XOR("48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 48 89 7C 24 20 41 54 41 56 41 57 48 81 EC C0 00 00 00 48 8B 9C")));
