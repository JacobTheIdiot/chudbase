...
SurfaceData_t* GameTrace_t::GetSurfaceData()
{
	...
	static fnGetSurfaceData oGetSurfaceData = reinterpret_cast<fnGetSurfaceData>(memory::GetAbsoluteAddress(memory::FindPattern(CLIENT_DLL, XOR("E8 ? ? ? ? 48 85 C0 74 ? 44 38 60")), 0x1, 0x0));
