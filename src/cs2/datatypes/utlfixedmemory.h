...
public:
	...
	void Grow(const int nCount = 1)
	{
		...
		BlockHeader_t* pNewBlockHeader = static_cast<BlockHeader_t*>(Interface::MemAlloc->Alloc(sizeof(BlockHeader_t) + nBlockSize * sizeof(T)));
