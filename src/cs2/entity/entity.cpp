...
// used: convars
#include "../convars.h"
#include "../interface/interfaces/cgameentitysystem.h"
#include "../interface/interfaces/ienginecvar.h"
#include "../interface/interfaces/iengineclient.h"
...
{
	const int nIndex = Interface::Engine->GetLocalPlayer();
	return Interface::GameResourceService->pGameEntitySystem->Get<CCSPlayerController>(nIndex);
}
...
const Vector_t& CCSPlayerController::GetPawnOrigin()
{
	...
	C_CSPlayerPawn* pPlayerPawn = Interface::GameResourceService->pGameEntitySystem->Get<C_CSPlayerPawn>(hPawnHandle);
...
{
	const int nIndex = Interface::Engine->GetLocalPlayer();
	return Interface::GameResourceService->pGameEntitySystem->Get(nIndex);
}
